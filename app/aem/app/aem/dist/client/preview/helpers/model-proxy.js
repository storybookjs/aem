...
var ModelProxy = /** @class */ (function () {
     ...
     */
    ModelProxy.prototype.use = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var content, _a, models, model;
            return __generator(this, function (_b) {
                content = context.content, _a = context.models, models = _a === void 0 ? {} : _a;
                model = models[this.id];
                if (!model) {
                ...
                return [2 /*return*/, new model(content)];
            });
        });
    };
    return ModelProxy;
